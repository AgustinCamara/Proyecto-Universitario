...
public:
    ...
    std::list<DTInmuebleAdministrado*> listarInmueblesAdministrados(const std::string& nicknameInmobiliaria);
    ...
    std::set<DTUsuario*> listarInmobiliariasNoSuscripto(const std::string& nicknameCliente);
    bool suscribirAInmobiliaria(const std::string& nicknameCliente, const std::string& nicknameInmobiliaria);
    ...
    bool desuscribirDeInmobiliaria(const std::string& nicknameCliente, const std::string& nicknameInmobiliaria);
};
