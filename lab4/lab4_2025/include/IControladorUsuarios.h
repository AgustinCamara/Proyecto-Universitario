...
class IControladorUsuarios{
    ...
    virtual std::set<DTUsuario> listarInmobiliariasNoSuscripto(std::string nicknameCliente)=0;
    virtual bool suscribirAInmobiliaria(std::string nicknameInmobiliaria)=0;
    ...
    virtual bool desuscribirDeInmobiliaria(std::string nicknameInmobiliaria) = 0;
